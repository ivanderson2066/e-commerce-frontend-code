        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none space-y-8 text-gray-700">
            <div>
              ...
              <p>
                Bem-vindo à Caiçara Mix. Estes Termos de Serviço ("Termos") regulam seu uso de nosso site 
                caicaramix.com.br e dos serviços oferecidos. Ao acessar ou usar nosso site, você concorda com 
                estes Termos em sua totalidade.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Você concorda em usar o site apenas para fins legítimos e de acordo com estas condições. 
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p>
                    Ao fazer um pedido, você está oferecendo para comprar produtos por um preço especificado. 
                    Aceitamos sua oferta e confirmamos a transação via email.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-[#374151] mb-2">Preços:</h3>
                  <p>
                    Os preços estão sujeitos a alterações sem aviso prévio. Os preços na hora da compra são 
                    os que você pagará (exceto erros óbvios).
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-[#374151] mb-2">Disponibilidade:</h3>
                  <p>
                    Reservamos o direito de cancelar qualquer pedido se o produto não estiver disponível ou 
                    se houver erro no preço ou descrição.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <p>
                Aceitamos várias formas de pagamento. Você concorda em fornecer informações precisas de 
                pagamento e autoriza-nos a cobrar o valor total da sua compra.
              </p>
              <p className="mt-3">
                Você é responsável por qualquer taxa de processamento de pagamento ou despesa de juros 
                incorrida em seu banco.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Fazemos o possível para entregar seus produtos dentro dos prazos estimados. No entanto, 
                não garantimos datas exatas de entrega.
              </p>
              <p className="mt-3">
                O risco de perda ou dano aos produtos passa para você quando recebe os itens ou quando 
                a transportadora toma posse deles.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Aceitamos devoluções de produtos não abertos em até 30 dias da compra. 
                O produto deve estar em perfeito estado com embalagem original.
              </p>
              <p className="mt-3">
            ...
            <div>
              ...
              <p>
                ...
                incidentais, especiais, consequentes ou punitivos resultantes do uso ou impossibilidade 
                de usar os produtos ou o site.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Todo conteúdo no site, incluindo texto, gráficos, logos, imagens e software, 
                é propriedade da Caiçara Mix ou de nossos fornecedores de conteúdo e é protegido 
            ...
            <div>
              ...
              <p>
                ...
                conteúdos, precisão ou práticas desses sites. Sua uso desses sites está sujeito 
                aos seus próprios termos e políticas.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                serão publicadas nesta página. Seu uso contínuo do site após as alterações constitui 
            ...
            <div>
              ...
              <p>
                Estes Termos são regidos pelas leis do Brasil. Qualquer disputa surgirá perante 
                os tribunais de São Paulo, Brasil.
              </p>
            </div>
